...
select gs_result.日期,gs_result.证券名称,gs_result.证券代码,gs_result.证券类别,
	   ...
	   gs_result.资本利得,gs_result.利息收入,gs_result.总体盈亏,gs_result.code_latest_par * gs_result.持仓数量 as 证券总面值,
	   gs_result.code_windl1_type as 万得证券分类,
	   gs_result.持仓数量 * case gs_result.code_exch_city when '银行间债券' then gs_result.code_dirty_cnbd else gs_result.code_dirty_price end as 全价总市值
  from gs_result
